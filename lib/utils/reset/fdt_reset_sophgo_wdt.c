...
static int sophgo_wdt_system_get_top_base(const void *fdt,
...
static int mango_wdt_reset_init(const void *fdt, int nodeoff,
...
const struct fdt_driver fdt_reset_sophgo_wdt = {
